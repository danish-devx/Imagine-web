import image from "../assets/undraw_gift_card_6ekc.svg";
import avatar from "../assets/person_4.jpg";

export default function CommunicateSection1() {
  return (
    <section className="py-12 sm:py-16 md:py-20 px-6 bg-white text-slate-800">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-16 items-center">
        <div className="flex justify-center items-center w-full  md:order-first">
          <img
            src={image}
        ...
        <div className="flex flex-col items-start justify-center">
          ...
          <p className="text-slate-600 text-base sm:text-lg leading-relaxed py-5 max-w-lg">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatem
            neque nisi architecto autem molestias corrupti officia veniam.
          </p>

          <div className="border-l-5 border-sky-600 pl-5 mt-2 space-y-4">
